...
function (+){T<:AbstractFloat}(a::T, b::T, ::Type{RoundingMode{:ToZero}})
    hi,lo = eftSum2(a,b)
...
function (square){T<:AbstractFloat}(a::T, b::T, ::Type{RoundingMode{:ToZero}})
    hi,lo = eftSquare(a,b)
    roundingToZero(hi, lo)
end

function (sqrt){T<:AbstractFloat}(a::T, b::T, ::Type{RoundingMode{:ToZero}})
